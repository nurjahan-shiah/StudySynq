            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div>
                ...
                <input
                  ...
                  className="ss-input"
                  style={{
                    borderColor: confirmPassword.length > 0 && !passwordsMatch ? "var(--ss-red)" : undefined,
                  }}
                />
                {confirmPassword.length > 0 && !passwordsMatch && (
                  <p style={{ fontSize: "0.78rem", color: "var(--ss-red)", marginTop: 6 }}>
              ...
              {error && (
                <div style={{
                  background: "rgba(214,48,49,.08)", border: "1px solid rgba(214,48,49,.3)",
                  borderRadius: 9, padding: "10px 14px", fontSize: "0.88rem", color: "var(--ss-red)",
                }}>
                  {error}
                </div>
              )}
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: "1rem", borderRadius: 10, marginTop: 4,
                  opacity: !formValid || loading ? 0.45 : 1,
